...
How many categorical variables are there? 5 (-6) categorical variables

How many numeric variables are there? 7 numeric variables

How many legendary? 65 legendary
...
Answer: It means the data is right-skewed; a tail of unusually high value is pulling the mean up.
...
Answer: Histogram are used for continuous data & Bar chart can be used for caterogorical data.
...
ggplot(pokedata, aes(x = sp_atk)) + 
  geom_histogram() +
  coord_cartesian(ylim = c(0, 25), xlim = c(100, 200))
