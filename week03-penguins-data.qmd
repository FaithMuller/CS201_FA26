...
ggplot(data = penguins_data, aes(x = flipper_length_mm, fill = species)) +
  geom_histogram(alpha = 0.99) +
  scale_fill_viridis_d(option = "magma", name = "Peguin Species") + # manual colors
  theme_bw() +
  labs(title = "Palmer Penguins' Flipper Length",
       subtitle = "Three species observed on three islands in the Palmer Archipelago",
       x = "Flippers Length (mm)",
...
ggplot(data = penguins_data, aes(x = species, y = flipper_length_mm, fill = species)) +
  ...
  theme_bw() +
  scale_fill_manual(values = c("darkorange", "darkorchid", "cyan")) +
  labs(title = "Palmer Penguins' Flipper Length",
       subtitle = "Three species observed on three islands in the Palmer Archipelago",
       x = "Flippers Length (mm)",
       y = "Number of Penguins") +
  theme(axis.title.x = element_text(angle = 45, hjust = 1, vjust = 1), legend.position = "none") +
  coord_flip()
```
...
ggplot(data = penguins_data, aes(x = flipper_length_mm, y = body_mass_g, colour = species)) +
      geom_point()
...
ggplot(data = penguins_data, aes(x = flipper_length_mm, y = body_mass_g, colour = species, shape = island)) +
  geom_point() +
...
amber <- ggplot(data = penguins_data, aes(x = culmen_depth_mm, y = body_mass_g, color = species)) + 
  geom_point(size = 2, alpha = 0.8) +
  geom_smooth(method = "lm", se = FALSE) +
  theme_bw() +
  scale_color_viridis_d(option = "turbo") +
